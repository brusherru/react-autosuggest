...
var Autosuggest = (function(_Component) {
  ...
  function Autosuggest(_ref2) {
    var alwaysRenderSuggestions = _ref2.alwaysRenderSuggestions,
      ...
      highlightedSuggestionIndex = _ref2.highlightedSuggestionIndex;
  ...
  _createClass(Autosuggest, [
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        if (
          ...
          nextProps.highlightedSectionIndex !==
            this.props.highlightedSectionIndex &&
          !(
            nextProps.highlightedSuggestionIndex ===
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        var prevHighlightedSectionIndex = prevState.highlightedSectionIndex,
          prevhighlightedSuggestionIndex = prevState.highlightedSuggestionIndex;

        var prevSuggestion = this.getSuggestion(
          prevHighlightedSectionIndex,
          prevhighlightedSuggestionIndex,
    ...
    },
    {
      ...
      value: function getSuggestion(
        ...
        var curSuggestions = pSuggestions || suggestions;

        if (multiSection) {
          return getSectionSuggestions(curSuggestions[sectionIndex])[
            suggestionIndex
          ];
        }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onSuggestionClick = function(event) {
    ...
    _this3.updateHighlightedSuggestion(sectionIndex, suggestionIndex);
  ...
  this.onSuggestionDoubleClick = function(event) {
    var _props6 = _this3.props,
      alwaysRenderSuggestions = _props6.alwaysRenderSuggestions,
      focusInputOnSuggestionClick = _props6.focusInputOnSuggestionClick;

    var _getSuggestionIndices2 = _this3.getSuggestionIndices(
        _this3.findSuggestionElement(event.target)
      ),
      sectionIndex = _getSuggestionIndices2.sectionIndex,
      suggestionIndex = _getSuggestionIndices2.suggestionIndex;
  ...
  this.itemProps = function(_ref3) {
    ...
    return {
      ...
      onDoubleClick: _this3.onSuggestionDoubleClick
    };
  };

  this.renderSuggestionsContainer = function(_ref4) {
